        ...
        >
          <div className="relative">
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-full overflow-hidden pointer-events-none">
              <ShineBorder shineColor={["#8B5CF6", "#A855F7"]} borderWidth={2} duration={3} />
            </div>
          </div>
          ...
          <AnimatePresence mode="wait">
            {!isCollapsed && (
              ...
              >
                ...
                <motion.div animate={{ rotate: isOpen ? -90 : 0 }} transition={{ type: "spring", stiffness: 300, damping: 25 }}>
          ...
          <DropdownMenuItem className="flex items-center gap-3 p-2 rounded-lg cursor-pointer" asChild>
            <motion.div whileHover={{ x: 4 }}>
              <Avatar className="h-8 w-8">
                <AvatarFallback className="bg-gradient-to-br from-purple-500 to-purple-700 text-white text-xs font-semibold">U</AvatarFallback>
              </Avatar>
