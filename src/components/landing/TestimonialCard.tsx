...
export const TestimonialCard = ({ quote, author, handle, featured = false, delay = 0 }: TestimonialCardProps) => {
  ...
  const avatarColors = [
    'from-[hsl(14,100%,64%)] to-[hsl(340,80%,55%)]',
    'from-[hsl(262,83%,58%)] to-[hsl(280,70%,50%)]',
    'from-[hsl(170,70%,45%)] to-[hsl(190,80%,40%)]',
    'from-[hsl(30,90%,55%)] to-[hsl(14,100%,64%)]',
    'from-[hsl(262,60%,65%)] to-[hsl(262,83%,58%)]',
  ];
  ...
  return (
    ...
    >
      <div className="bg-white/[0.02] border border-white/10 p-6 rounded-xl shadow-lg flex flex-col h-full hover:bg-white/[0.04] transition-all duration-300">
        ...
        {featured && (
          <div className="mb-3 text-landing-coral">
